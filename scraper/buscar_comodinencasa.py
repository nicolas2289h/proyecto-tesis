#!/usr/bin/env python
"""
Script de búsqueda interactiva para Comodín en Casa.
Permite ingresar un término de búsqueda por consola, interactúa directamente con el buscador de la página,
y extrae todos los resultados con la misma lógica robusta que probar_pagina_especifica.py.
"""
...
# Configurar logging
setup_logging()
logger = logging.getLogger("scraper.search_comodin")


async def main_async():
    print("=" * 80)
    print("       SCRAPER DE BÚSQUEDA - COMODÍN EN CASA")
    print("=" * 80)
    print()
    ...
    async with async_playwright() as p:
        ...
        scraper = ComodinEncasaScraper()

        # Realizar la búsqueda y scrapear resultados (usa la nueva lógica que interactúa con el buscador)
    ...
    output_file = os.path.join(scraper_dir, "resultados_comodinencasa.json")
