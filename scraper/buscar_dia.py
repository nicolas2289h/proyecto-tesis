#!/usr/bin/env python
"""
Script de búsqueda interactiva para Dia.
...
# Configurar logging
setup_logging()
logger = logging.getLogger("scraper.search_dia")


async def main_async():
    print("=" * 80)
    print("       SCRAPER DE BÚSQUEDA - DIA")
    print("=" * 80)
    print()
    ...
    output_file = os.path.join(scraper_dir, "resultados_dia.json")
